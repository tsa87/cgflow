...
from rxnflow.config import AlgoConfig, ModelConfig, OptimizerConfig, ReplayConfig, ConditionalsConfig
from cgflow.tasks.config import TasksConfig
...
class Config(config.Config):
    ...
    semlaflow: SemlaFlowConfig = field(default_factory=SemlaFlowConfig)
