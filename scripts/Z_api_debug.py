...
from cgflow.api.api import SemlaFlowAPI
from cgflow.api.cfg import get_cfg_plinder
...
class Prediction:
    ...
    def get_trajectory(
        ...
        upd_mols, traj_xt, traj_x1 = self.semla_api.step([mol], traj_idx, is_last_step, return_traj=True)
...
if __name__ == "__main__":
    ...
    target = "ALDH1"
    module = Prediction(
        # "./weights/crossdocked_mini_epoch97.ckpt",
        "./weights/plinder_epoch426.ckpt",
    ...
    for step in range(4):
        ...
        mol, traj_xt, traj_x1 = module.get_trajectory(mol, step, (step == 3))
